...
Update History:
     ...
     V1.6 : Main document change description:
            ...
            3. Updated resistor and MOS/Junction Varactor correlative model card except for ELDO format model card. ELDO model card for Resistor and MOS/Junction Vractor will release in next version. 
            4. Included top metal resistor (m6) model card in Hspice/Spectre/Eldo format.
     V1.7 : Main document is not changed expect update version form 1.6 to 1.7.
            Attachment change description:
	    1. Correct deep n well port number in SPECTRE format model card.
     V1.8 : Update MOS model(extend finger from 20 to 128)
     V1.9 : Add model card for 3-terminal differential inductor

    	   
Files:

      ms018_rf_v1p9_readme.txt             .... This file!
      ms018_rf_v1p9.lib                    .... Corner values for MOSFETs, resistors and MIM
      ms018_rf_v1p9_mos.ckt                .... Subcircuit model of MOSFETs
      ms018_rf_v1p9_ind.ckt                .... Subcircuit model of inductor 
      ms018_rf_v1p9_var.ckt                .... Subcircuit model of varactors
      ms018_rf_v1p9_res.ckt                .... Subcircuit model of resistors
      ms018_rf_v1p9_m6_res.mdl             ....  model of m6 resistors
      ms018_rf_v1p9_mim.ckt                .... Subcircuit model of MIM 
      ms018_rf_v1p9_3T_diff_ind.ckt                .... Subcircuit model of 3T differential inductor 	
      ...
      3T_DIFF_IND_W8S1D5R30N3.gds      .... GDSII file for3T_ Differential Inductor W/S/R/T=8/1.5/30/3
